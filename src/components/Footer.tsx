...
import { Zap, Instagram, Send, Phone, Mail, MapPin } from 'lucide-react';
    ...
    <footer className="bg-gray-900 text-white pt-16 pb-8 border-t border-gray-800">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          {/* Navigation */}
          <div>
            <h3 className="text-lg font-bold mb-6">Навігація</h3>
          ...
          {/* Services */}
          <div>
            <h3 className="text-lg font-bold mb-6">Послуги</h3>
            <ul className="space-y-3">
              {[
              'Діагностика',
              'Ремонт генераторів',
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-gray-400">
                  вулиця Одеська 58/1, Одеса, Україна
                </span>
              </li>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-500">
          <p>&copy; 2026 ГенераторСервіс. Всі права захищено.</p>
          <p>Розроблено з любов'ю до енергії.</p>
        </div>
      </div>
    </footer>);
